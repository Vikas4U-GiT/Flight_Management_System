...
<body>  
	  	<div class="header">
    		<h1 style="color:#fbff08;">Airlines Booking Platform</h1>
    		<p style="color:#fbff08;">Book Flight tickets and Keep track of your Booking History</p>
    	</div>
    	<div class="topnav">
		...
		<div class="column">
		<h3 style="color:#fbff08;">Passenger Details</h3>
