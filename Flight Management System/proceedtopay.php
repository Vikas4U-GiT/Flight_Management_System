...
<style>
html{
   background-image:url("proceed_To_pay.jpg");
   background-size:100%;
}
    ...
    <body>
    	<div class="header">
    		<h1 style="color:white;">Airlines Booking Platform</h1>
    		<p style="color:white;">Book Flight tickets and Keep track of your Booking History</p>
    	</div>
    	<div class="topnav">
